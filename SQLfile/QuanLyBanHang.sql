...
SET DEFINE OFF;
Insert into LOAI_SP (MALOAI,TENLOAI) values ('001',N'Điện Tho?i - Máy Tính Bảng');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('002',N'Điện Tử - Điện Lạnh');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('003',N'Sách, VPP, Quà Tặng');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('004',N'Thời Trang - Phụ Kiện');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('005',N'Đồ Chơi, Mẹ \& Bé');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('006',N'Điện Gia Dụng');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('007',N'Laptop - Thiết Bị IT');
Insert into LOAI_SP (MALOAI,TENLOAI) values ('008',N'Nhà Cửa Đời Sống');
